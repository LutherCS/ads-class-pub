...
@pytest.mark.parametrize(
    "a_string, an_answer",
    [("abxaby", "x"), ("y", "y"), ("abxbac", "x"), (ascii_lowercase, "a")],
)
...
def test_find_non_repeat_long_unique(str_len):
...
@pytest.mark.timeout(TIME_LIMIT)
@pytest.mark.parametrize("str_len", [10, 100, 10000, 1_000_000])
def test_find_non_repeat_long_success(str_len):
...
@pytest.mark.timeout(TIME_LIMIT)
def test_find_non_repeat_long_error():
