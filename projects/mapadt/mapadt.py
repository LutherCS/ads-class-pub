...
def main():
    ...
    print(f"Produced output: {my_map}")
    ...
    print(f"Produced output: {my_map[18]}")
    print("Expected output: deer")
    print(f"Produced output: {my_map[21]}")
    ...
    print(f"Produced output: {18 in my_map}")
    print("Expected output: False")
    print(f"Produced output: {81 in my_map}")

    print("Size")
    print("Expected output: 4")
    print(f"Produced output: {len(my_map)}")

    print("Keys (raw)")
    print("Expected output: [20, 61, 21, 18, None]")
    print(f"Produced output: {my_map._keys}")
    ...
    print(f"Produced output: {my_map.keys()}")

    print("Values (raw)")
    print("Expected output: ['cat', 'bee', 'dog', 'ant', None]")
    print(f"Produced output: {my_map._values}")

    print("Values (method)")
    print("Expected output: ['cat', 'bee', 'dog', 'ant']")
    print(f"Produced output: {my_map.values()}")

    print("Items (method)")
    print("Expected output: [(20, 'cat'), (61, 'bee'), (21, 'dog'), (18, 'ant')]")
    print(f"Produced output: {my_map.items()}")
